...
- [ ] 6. FAQ schema sync — ~70 learn pages where FAQPage JSON-LD lists fewer questions than the rendered FAQAccordion; single-source each page, add seo:faq gate. Acceptance: seo:faq exits 0, build green.
