...
5. Generate a unique, fact-safe editorial image for every article. Save it under `public/news`, add accurate alt text, and verify that it appears as the article hero and social preview. The image must be at least 1200 pixels wide and use a wide editorial aspect ratio.
