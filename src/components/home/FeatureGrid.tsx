    ...
    <section className="border-y border-surface-border bg-surface-card" aria-labelledby="research-standard-heading">
      <div className="site-container grid gap-12 py-16 sm:py-20 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        <div className="max-w-xl">
          <p className="text-sm font-semibold text-xrp-accent-bright">Our research standard</p>
        ...
        <div className="divide-y divide-surface-border border-y border-surface-border">
          {standards.map((item) => (
            <div key={item.title} className="grid gap-4 py-7 sm:grid-cols-[44px_1fr] sm:gap-5">
              <div className="flex h-11 w-11 items-center justify-center text-xrp-accent">
