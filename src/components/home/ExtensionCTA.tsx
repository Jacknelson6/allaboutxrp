...
export default function ExtensionCTA() {
  return (
    <section className="mx-auto max-w-5xl px-5 py-12" aria-label="Chrome Extension">
      <div className=" border border-[#0085FF]/20 bg-[#0A0A0B] relative overflow-hidden">
        {/* Subtle glow */}
        <div className="absolute top-0 right-0 w-64 h-64 bg-[#0085FF]/5  blur-3xl -translate-y-1/2 translate-x-1/2" />
        <div className="relative px-6 py-10 sm:px-12 sm:py-12">
          <div className="flex flex-col items-center text-center max-w-lg mx-auto">
            <div className="inline-flex items-center justify-center w-12 h-12  border border-[#0085FF]/20 bg-[#0085FF]/10 text-[#0085FF] mb-5">
            ...
            <Link
              href="/tools"
              className="mt-6 inline-flex items-center gap-2  bg-[#0085FF] px-6 py-2.5 text-[14px] font-bold text-white hover:bg-[#0070DD] transition-all hover: hover:gap-3"
            >
              Learn More
