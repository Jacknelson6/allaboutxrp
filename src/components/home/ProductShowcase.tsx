  ...
  return (
    <section className="mx-auto max-w-5xl px-5 py-16" aria-label="Product showcase">
      ...
      <div className="grid gap-5 lg:grid-cols-2">
        {/* Price card — CryptoSea "Daily P&L" style */}
        <div className="relative overflow-hidden rounded-2xl border border-white/[0.06] bg-[#0A0A0B] p-6">
          <div className="pointer-events-none absolute top-0 right-0 w-48 h-48 bg-[radial-gradient(circle,rgba(0,133,255,0.06)_0%,transparent_70%)]" />
        ...
        {/* Supply / Escrow card — CryptoSea "portfolio" style */}
        <div className="relative overflow-hidden rounded-2xl border border-white/[0.06] bg-[#0A0A0B] p-6">
          <div className="pointer-events-none absolute bottom-0 left-0 w-48 h-48 bg-[radial-gradient(circle,rgba(0,186,124,0.05)_0%,transparent_70%)]" />
          <div className="relative">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-2">
            ...
            <div className="space-y-4">
              ...
              <SupplyRow label="In Escrow" value="~33,900,000,000" pct={33.9} color="bg-amber-500" />
              <SupplyRow label="Burned" value="~14,260,000" pct={0.01} color="bg-red-500" />
            </div>
