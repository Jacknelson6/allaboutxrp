    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-3">
        ...
        <Link href="/" className="group flex items-center gap-2 transition-opacity hover:opacity-80">
          <svg viewBox="0 0 512 424" xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 shrink-0"><path d="M437,0h74L357,152.48c-55.77,55.19-146.19,55.19-202,0L.94,0H75L192,115.83a91.11,91.11,0,0,0,127.91,0Z" fill="#ffffff"/><path d="M74.05,424H0L155,270.58c55.77-55.19,146.19-55.19,202,0L512,424H438L320,307.23a91.11,91.11,0,0,0-127.91,0Z" fill="#ffffff"/></svg>
          <span style={{ fontFamily: 'var(--font-display)' }}><span className="text-[15px] font-semibold text-white">All About </span><span className="text-[15px] font-semibold text-[#0085FF]">XRP</span></span>
        </Link>
