  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* Full logo: "ALL ABOUT" text + XRP wordmark */}
        <div
          style={{
            display: "flex",
            alignItems: "center",
        ...
        >
          ...
          {/* XRP wordmark (X symbol + R + P as vector paths) */}
          <svg viewBox="0 0 2499.1 698" width="210" height="59">
            <g fill="#ffffff">
              <path d="m704.1 0h119.3l-248.3 251c-89.9 90.9-235.5 90.9-325.4 0l-248.2-251h119.3l188.6 190.7c56 56.9 147.6 57.6 204.5 1.6.5-.5 1.1-1.1 1.6-1.6zm-584.8 698h-119.3l249.8-252.6c89.9-90.9 235.5-90.9 325.4 0l249.7 252.6h-119.3l-190.1-192.2c-56-56.9-147.6-57.6-204.5-1.6-.5.5-1.1 1.1-1.6 1.6z"/>
