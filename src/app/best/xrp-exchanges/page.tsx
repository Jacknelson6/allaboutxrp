...
const exchanges = [
  {
    ...
    verdict: "The #1 exchange for XRP — Uphold stood by XRP and never delisted it during the SEC lawsuit, earning the trust of the XRP community.",
    pros: ["Never delisted XRP during the SEC lawsuit", "Buy XRP directly with USD/EUR/GBP", "Very simple interface", "Auto-recurring purchases", "Multi-asset platform (crypto, metals, fiat)"],
