          ...
          <section className="mb-16">
            ...
            <div className="space-y-4">
              {faqItems.map((f) => (
                <details
                  key={f.q}
                  className="group  border border-zinc-800 bg-zinc-950 overflow-hidden"
                >
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <Link
                  key={href}
                  href={href}
                  className=" border border-zinc-700 px-3 py-1.5 text-sm text-zinc-400 hover:border-[#0085FF] hover:text-[#0085FF] transition-colors"
                >
                  {label}
                </Link>
              ))}
