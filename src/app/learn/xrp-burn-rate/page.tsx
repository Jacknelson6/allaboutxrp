          ...
          <RevealSection id="impact" delay={0.05}>
            ...
            <div className="mt-6">
              <HighlightBox title="What Actually Drives XRP's Price" variant="info">
                <p>XRP&apos;s price is driven by <strong className="text-text-primary">demand</strong> (institutional adoption, <Link href="/learn/on-demand-liquidity" className="text-xrp-accent underline decoration-xrp-accent/30">ODL usage</Link>, <Link href="/learn/xrp-etf" className="text-xrp-accent underline decoration-xrp-accent/30">ETF flows</Link>, speculative trading) and <strong className="text-text-primary">supply dynamics</strong> (<Link href="/learn/escrow" className="text-xrp-accent underline decoration-xrp-accent/30">escrow releases</Link>, market selling). The burn mechanism is a nice design feature but not a price catalyst. See <Link href="/learn/xrp-tokenomics" className="text-xrp-accent underline decoration-xrp-accent/30">XRP tokenomics</Link> for what actually affects supply/demand.</p>
              </HighlightBox>
            </div>
          </RevealSection>
