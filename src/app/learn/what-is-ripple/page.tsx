          ...
          <RevealSection delay={0.05}>
            ...
            <div className="mt-4">
              <HighlightBox title="The Bridge Between TradFi & Blockchain" variant="accent" large>
                ...
                <p className="mt-3">No other crypto company has this combination of regulatory licenses, institutional partnerships, and full-stack financial infrastructure. Explore the <Link href="/learn/acquisitions" className="text-xrp-accent underline decoration-xrp-accent/30">$3.7B acquisition strategy</Link>.</p>
              </HighlightBox>
            </div>
          </RevealSection>
