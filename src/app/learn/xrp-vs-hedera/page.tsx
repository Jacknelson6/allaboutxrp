      ...
      <div className="relative mx-auto max-w-4xl px-4 py-16">
        ...
        <div className="cv-auto mt-14 space-y-14">
          ...
          <RevealSection delay={0.05}>
            ...
            <LearnLinkGrid links={[
              { href: "/learn/xrp-vs-bitcoin", label: "XRP vs Bitcoin", desc: "The fundamental comparison" },
              { href: "/learn/xrp-vs-stellar", label: "XRP vs Stellar", desc: "Payment crypto rivals" },
              { href: "/learn/xrp-vs-swift", label: "XRP vs SWIFT", desc: "Traditional payments" },
              { href: "/learn/xrp-iso-20022", label: "XRP and ISO 20022", desc: "Institutional standard" },
