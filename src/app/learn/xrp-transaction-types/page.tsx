      ...
      <div className="relative mx-auto max-w-4xl px-4 py-16">
        ...
        <div className="cv-auto mt-14 space-y-14">
          ...
          <RevealSection delay={0.05}>
            ...
            <LearnLinkGrid links={[
              { href: "/learn/xrp-addresses-and-keys", label: "Addresses & Keys", desc: "How XRPL accounts work" },
              { href: "/learn/xrp-ledger-explained", label: "XRPL Explained", desc: "Consensus and architecture" },
              { href: "/learn/escrow", label: "Escrow Deep Dive", desc: "Ripple's 55B XRP escrow" },
              { href: "/learn/xrp-stablecoin-ecosystem", label: "Stablecoin Ecosystem", desc: "RLUSD and trust lines" },
              { href: "/learn/xrpl-validators", label: "Validators & Consensus", desc: "How transactions are validated" },
              { href: "/learn/xrp-tokenomics", label: "XRP Tokenomics", desc: "Fees, burns & supply" },
            ]} />
          </RevealSection>
        </div>
