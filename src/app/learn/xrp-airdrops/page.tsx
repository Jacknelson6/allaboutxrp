...
const schemas = [
  buildArticleSchema({ headline: "XRP Airdrops: How to Get Free XRPL Tokens", description: "A comprehensive guide to XRP and XRPL token airdrops — how they work, how to qualify, and how to avoid scams.", url: "https://allaboutxrp.com/learn/xrp-airdrops", datePublished: "2026-02-15", dateModified: "2026-07-27" }),
...
const faqItems = [
  ...
  { q: "What is a trust line?", a: "A connection on the XRPL that allows your wallet to hold a specific token. Requires a 0.2 XRP reserve per trust line." },
    ...
    <>
      ...
      <div className="relative mx-auto max-w-4xl px-4 py-16">
        ...
        <KeyFactsTable facts={[
          ...
          { label: "Trust Line Cost", value: "0.2 XRP reserve per line" },
          ...
          <RevealSection id="trust-lines" delay={0.05}>
            ...
            <div className="mt-6">
              <HighlightBox title="Trust Line Costs" variant="info">
                <p>Each trust line requires a <strong className="text-text-primary">0.2 XRP owner reserve</strong> that&apos;s locked while the trust line exists. This isn&apos;t a fee — it&apos;s returned when you remove the trust line. If you set 10 trust lines, 2 XRP is reserved. Factor this into your balance when preparing for airdrops. Learn more about <Link href="/learn/xrp-addresses-and-keys" className="text-xrp-accent underline decoration-xrp-accent/30">XRP addresses and reserves</Link>.</p>
              </HighlightBox>
            </div>
          </RevealSection>
        ...
        <p className="mt-8 text-xs text-text-secondary/60"><em>Last updated: July 27, 2026. Written by the AllAboutXRP Editorial Team. This is not financial or tax advice. Sources: XRPL.org, community resources.</em></p>
      </div>
    </>
  );
}
