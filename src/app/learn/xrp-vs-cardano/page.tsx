      ...
      <div className="relative mx-auto max-w-4xl px-4 py-16">
        ...
        <div className="cv-auto mt-14 space-y-14">
          ...
          <RevealSection id="use-cases" delay={0.05}>
            ...
            <div className="mt-6">
              <HighlightBox title="XRP Excels At" variant="accent">
                <p><Link href="/learn/cross-border-payments" className="text-xrp-accent underline decoration-xrp-accent/30">Cross-border payments</Link>, <Link href="/learn/on-demand-liquidity" className="text-xrp-accent underline decoration-xrp-accent/30">institutional settlement</Link>, bridge currency for <Link href="/learn/cbdcs-and-xrp" className="text-xrp-accent underline decoration-xrp-accent/30">CBDCs</Link>, <Link href="/learn/xrp-real-world-assets" className="text-xrp-accent underline decoration-xrp-accent/30">real-world asset tokenization</Link>, stablecoin infrastructure (<Link href="/learn/rlusd" className="text-xrp-accent underline decoration-xrp-accent/30">RLUSD</Link>), and <Link href="/learn/xrp-iso-20022" className="text-xrp-accent underline decoration-xrp-accent/30">ISO 20022 compliant</Link> financial messaging.</p>
              </HighlightBox>
            </div>
            <div className="mt-4">
          ...
          <RevealSection id="adoption" delay={0.05}>
            ...
            <p className="mt-4 text-text-secondary leading-relaxed">
              In terms of institutional and enterprise adoption, XRP has a commanding lead. Ripple&apos;s <Link href="/learn/partnerships" className="text-xrp-accent underline decoration-xrp-accent/30">300+ partnerships</Link> with banks and financial institutions, live payment corridors in <Link href="/learn/how-banks-use-xrp" className="text-xrp-accent underline decoration-xrp-accent/30">55+ countries</Link>, and pending <Link href="/learn/xrp-etf" className="text-xrp-accent underline decoration-xrp-accent/30">ETF applications</Link> give it far more institutional traction.
            </p>
            <p className="mt-4 text-text-secondary leading-relaxed">
