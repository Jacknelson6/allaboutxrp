...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: { path: string; changeFrequency: "hourly" | "daily" | "weekly" | "monthly"; priority: number; lastmod?: Date }[] = [
    ...
    // Additional learn pages
    { path: "/learn/banks-using-xrp", changeFrequency: "weekly", priority: 0.8, lastmod: now },
    { path: "/learn/best-xrp-trading-pairs", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/can-xrp-be-mined", changeFrequency: "monthly", priority: 0.7, lastmod: now },
    { path: "/learn/can-xrp-reach-100", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/cbdcs-and-xrp", changeFrequency: "weekly", priority: 0.8, lastmod: now },
    { path: "/learn/crypto-regulation-xrp-impact", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/crypto-wallets-for-xrp", changeFrequency: "weekly", priority: 0.8, lastmod: now },
    { path: "/learn/how-does-xrp-work", changeFrequency: "weekly", priority: 0.85, lastmod: now },
    { path: "/learn/how-to-create-xrpl-token", changeFrequency: "weekly", priority: 0.8, lastmod: now },
    { path: "/learn/how-to-read-xrp-charts", changeFrequency: "weekly", priority: 0.8, lastmod: now },
    { path: "/learn/how-to-send-xrp", changeFrequency: "weekly", priority: 0.85, lastmod: now },
    { path: "/learn/how-to-stake-xrp", changeFrequency: "weekly", priority: 0.8, lastmod: now },
    { path: "/learn/how-to-store-xrp-safely", changeFrequency: "weekly", priority: 0.85, lastmod: now },
    { path: "/learn/how-to-use-xrpl-dex", changeFrequency: "weekly", priority: 0.8, lastmod: now },
    { path: "/learn/is-xrp-a-security", changeFrequency: "weekly", priority: 0.8, lastmod: now },
    { path: "/learn/ripple-ipo", changeFrequency: "monthly", priority: 0.7, lastmod: now },
    { path: "/learn/ripple-vs-xrp", changeFrequency: "weekly", priority: 0.8, lastmod: now },
    { path: "/learn/rlusd-explained", changeFrequency: "weekly", priority: 0.85, lastmod: now },
    { path: "/learn/sec-vs-ripple-explained", changeFrequency: "weekly", priority: 0.85, lastmod: now },
    { path: "/learn/why-is-xrp-so-cheap", changeFrequency: "monthly", priority: 0.7, lastmod: now },
    { path: "/learn/xrp-2026-outlook", changeFrequency: "weekly", priority: 0.8, lastmod: now },
    { path: "/learn/xrp-accumulation-zones", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/xrp-africa-remittances", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/xrp-airdrops", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/xrp-altseason-guide", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/xrp-amm", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/xrp-bull-run-indicators", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/xrp-burn-rate", changeFrequency: "monthly", priority: 0.7, lastmod: now },
    { path: "/learn/xrp-common-mistakes", changeFrequency: "monthly", priority: 0.7, lastmod: now },
    { path: "/learn/xrp-dollar-cost-averaging", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/xrp-energy-consumption", changeFrequency: "monthly", priority: 0.7, lastmod: now },
    { path: "/learn/xrp-escrow-explained", changeFrequency: "weekly", priority: 0.8, lastmod: now },
    { path: "/learn/xrp-european-regulation", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/xrp-exit-strategy", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/xrp-for-beginners", changeFrequency: "weekly", priority: 0.85, lastmod: now },
    { path: "/learn/xrp-institutional-custody", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/xrp-interledger-protocol", changeFrequency: "monthly", priority: 0.7, lastmod: now },
    { path: "/learn/xrp-iso-20022", changeFrequency: "weekly", priority: 0.8, lastmod: now },
    { path: "/learn/xrp-japan-sbi", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/xrp-market-cap-explained", changeFrequency: "monthly", priority: 0.7, lastmod: now },
    { path: "/learn/xrp-middle-east-adoption", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/xrp-nfts", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/xrp-portfolio-allocation", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/xrp-price-potential", changeFrequency: "weekly", priority: 0.8, lastmod: now },
    { path: "/learn/xrp-real-world-assets", changeFrequency: "weekly", priority: 0.8, lastmod: now },
    { path: "/learn/xrp-smart-contracts", changeFrequency: "weekly", priority: 0.8, lastmod: now },
    { path: "/learn/xrp-southeast-asia", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/xrp-spot-etf-vs-futures-etf", changeFrequency: "weekly", priority: 0.8, lastmod: now },
    { path: "/learn/xrp-swing-trading-guide", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/xrp-technical-analysis-guide", changeFrequency: "weekly", priority: 0.8, lastmod: now },
    { path: "/learn/xrp-vs-cardano", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/xrp-vs-hedera", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/xrp-vs-stellar", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/xrp-vs-stocks", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/xrp-vs-swift", changeFrequency: "weekly", priority: 0.8, lastmod: now },
    { path: "/learn/xrp-whale-tracking", changeFrequency: "weekly", priority: 0.75, lastmod: now },
    { path: "/learn/xrpl-consensus-mechanism", changeFrequency: "monthly", priority: 0.7, lastmod: now },
    { path: "/learn/xrpl-decentralization", changeFrequency: "monthly", priority: 0.7, lastmod: now },
    { path: "/learn/xrpl-payment-channels", changeFrequency: "monthly", priority: 0.7, lastmod: now },
    { path: "/learn/xrpl-sidechains", changeFrequency: "weekly", priority: 0.8, lastmod: now },
    { path: "/learn/xrpl-trust-lines-explained", changeFrequency: "weekly", priority: 0.75, lastmod: now },
